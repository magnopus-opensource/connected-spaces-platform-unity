...
public class ApplicationSettingsSystem : csp.systems.SystemBase {
  private global::System.Runtime.InteropServices.HandleRef swigCPtr;

  internal ApplicationSettingsSystem(global::System.IntPtr cPtr, bool cMemoryOwn) : base(ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_ApplicationSettingsSystem_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
  }

  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(ApplicationSettingsSystem obj) {
    return (obj == null) ? new global::System.Runtime.InteropServices.HandleRef(null, global::System.IntPtr.Zero) : obj.swigCPtr;
  }

  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(ApplicationSettingsSystem obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void GetSettingsByContext(string ApplicationName, string Context, csp.common.StringArray Keys, ApplicationSettingsResultCallbackAdapter Callback) {
    ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_ApplicationSettingsSystem_GetSettingsByContext(swigCPtr, ApplicationName, Context, csp.common.StringArray.getCPtr(Keys), ApplicationSettingsResultCallbackAdapter.getCPtr(Callback));
  ...
  public void GetSettingsByContextAnonymous(string Tenant, string ApplicationName, string Context, csp.common.StringArray Keys, ApplicationSettingsResultCallbackAdapter Callback) {
    ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_ApplicationSettingsSystem_GetSettingsByContextAnonymous(swigCPtr, Tenant, ApplicationName, Context, csp.common.StringArray.getCPtr(Keys), ApplicationSettingsResultCallbackAdapter.getCPtr(Callback));
    if (ConnectedSpacesPlatformDotNetPINVOKE.SWIGPendingException.Pending) throw ConnectedSpacesPlatformDotNetPINVOKE.SWIGPendingException.Retrieve();
  }


  public System.Threading.Tasks.Task<csp.systems.ApplicationSettingsResult> GetSettingsByContextAsync(string applicationName,string context,csp.common.StringArray? keys, System.Action<float>? progressCallback = null)
  {
    // Create a TaskCompletionSource to represent the async operation.
    System.Threading.Tasks.TaskCompletionSource<csp.systems.ApplicationSettingsResult> tcs = 
        new System.Threading.Tasks.TaskCompletionSource<csp.systems.ApplicationSettingsResult>(System.Threading.Tasks.TaskCreationOptions.RunContinuationsAsynchronously);
    ...
    ConnectedSpacesPlatformDotNet.ApplicationSettingsResultCallback callback =
        new ConnectedSpacesPlatformDotNet.ApplicationSettingsResultCallback();

    // Define the callback that will be called by the C++ code
    System.Action<csp.systems.ApplicationSettingsResult>? handler = null;
    handler = new ((csp.systems.ApplicationSettingsResult result) =>
    {
        try
        {
            ...
            * Sometime's it's just a space entity, or a bool, or something else. */
            ...
            if((object)result is csp.systems.ResultBase _result)
            {
                ...
                _result.ThrowOnFailure(nameof(GetSettingsByContextAsync));
...
/*@SWIG@*/;
    ...
    GetSettingsByContext(applicationName,context,keys, callback);

    return tcs.Task;
  }


  public System.Threading.Tasks.Task<csp.systems.ApplicationSettingsResult> GetSettingsByContextAnonymousAsync(string tenant,string applicationName,string context,csp.common.StringArray? keys, System.Action<float>? progressCallback = null)
  {
    // Create a TaskCompletionSource to represent the async operation.
    System.Threading.Tasks.TaskCompletionSource<csp.systems.ApplicationSettingsResult> tcs = 
        new System.Threading.Tasks.TaskCompletionSource<csp.systems.ApplicationSettingsResult>(System.Threading.Tasks.TaskCreationOptions.RunContinuationsAsynchronously);
        ...
        try
        {
            ...
            * Sometime's it's just a space entity, or a bool, or something else. */
            ...
            if((object)result is csp.systems.ResultBase _result)
            {
                ...
                // Convert the failing result to a throw if we have that option enabled
                _result.ThrowOnFailure(nameof(GetSettingsByContextAnonymousAsync));
...
/*@SWIG@*/;
    ...
    // Run the method with the provided arguments and the callback
    // callback is defined in MAKE_AWAITABLE_CALLBACK_BODY
    GetSettingsByContextAnonymous(tenant,applicationName,context,keys, callback);
