...
public class MaintenanceSystem : csp.systems.SystemBase {
  ...
  internal MaintenanceSystem(global::System.IntPtr cPtr, bool cMemoryOwn) : base(ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_MaintenanceSystem_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
  }

  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(MaintenanceSystem obj) {
    return (obj == null) ? new global::System.Runtime.InteropServices.HandleRef(null, global::System.IntPtr.Zero) : obj.swigCPtr;
  }

  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(MaintenanceSystem obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void GetMaintenanceInfo(string MaintenanceURL, MaintenanceInfoCallbackAdapter Callback) {
    ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_MaintenanceSystem_GetMaintenanceInfo(swigCPtr, MaintenanceURL, MaintenanceInfoCallbackAdapter.getCPtr(Callback));
  ...
  public System.Threading.Tasks.Task<csp.systems.MaintenanceInfoResult> GetMaintenanceInfoAsync(string maintenanceURL, System.Action<float>? progressCallback = null)
  {
    ...
    System.Threading.Tasks.TaskCompletionSource<csp.systems.MaintenanceInfoResult> tcs = 
        new System.Threading.Tasks.TaskCompletionSource<csp.systems.MaintenanceInfoResult>(System.Threading.Tasks.TaskCreationOptions.RunContinuationsAsynchronously);
    ...
    ConnectedSpacesPlatformDotNet.MaintenanceInfoCallback callback =
        new ConnectedSpacesPlatformDotNet.MaintenanceInfoCallback();

    // Define the callback that will be called by the C++ code
    System.Action<csp.systems.MaintenanceInfoResult>? handler = null;
    handler = new ((csp.systems.MaintenanceInfoResult result) =>
    {
        try
        {
            ...
            * Sometime's it's just a space entity, or a bool, or something else. */
            ...
            if((object)result is csp.systems.ResultBase _result)
            {
                ...
                _result.ThrowOnFailure(nameof(GetMaintenanceInfoAsync));
...
/*@SWIG@*/;
    ...
    GetMaintenanceInfo(maintenanceURL, callback);
