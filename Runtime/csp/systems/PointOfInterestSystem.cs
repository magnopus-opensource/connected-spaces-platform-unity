...
public class PointOfInterestSystem : csp.systems.SystemBase {
  ...
  internal PointOfInterestSystem(global::System.IntPtr cPtr, bool cMemoryOwn) : base(ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_PointOfInterestSystem_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
  }

  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(PointOfInterestSystem obj) {
    return (obj == null) ? new global::System.Runtime.InteropServices.HandleRef(null, global::System.IntPtr.Zero) : obj.swigCPtr;
  }

  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(PointOfInterestSystem obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void CreatePOI(string Title, string Description, string Name, csp.common.StringArray Tags, csp.systems.EPointOfInterestType Type, string Owner, csp.systems.GeoLocation Location, csp.systems.AssetCollection AssetCollection, POIResultCallbackAdapter Callback) {
    ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_PointOfInterestSystem_CreatePOI(swigCPtr, Title, Description, Name, csp.common.StringArray.getCPtr(Tags), (int)Type, Owner, csp.systems.GeoLocation.getCPtr(Location), csp.systems.AssetCollection.getCPtr(AssetCollection), POIResultCallbackAdapter.getCPtr(Callback));
  ...
  public void DeletePOI(csp.systems.PointOfInterest POI, NullResultCallbackAdapter Callback) {
    ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_PointOfInterestSystem_DeletePOI(swigCPtr, csp.systems.PointOfInterest.getCPtr(POI), NullResultCallbackAdapter.getCPtr(Callback));
    if (ConnectedSpacesPlatformDotNetPINVOKE.SWIGPendingException.Pending) throw ConnectedSpacesPlatformDotNetPINVOKE.SWIGPendingException.Retrieve();
  }

  public void GetPOIsInArea(csp.systems.GeoLocation OriginLocation, double AreaRadius, csp.systems.EPointOfInterestType? Type, POICollectionResultCallbackAdapter Callback) {
    csp.common.OptEPointOfInterestType opt_Type = Type.HasValue ? new csp.common.OptEPointOfInterestType(Type.Value) : new csp.common.OptEPointOfInterestType();
    {
      ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_PointOfInterestSystem_GetPOIsInArea(swigCPtr, csp.systems.GeoLocation.getCPtr(OriginLocation), AreaRadius, csp.common.OptEPointOfInterestType.getCPtr(opt_Type), POICollectionResultCallbackAdapter.getCPtr(Callback));
      if (ConnectedSpacesPlatformDotNetPINVOKE.SWIGPendingException.Pending) throw ConnectedSpacesPlatformDotNetPINVOKE.SWIGPendingException.Retrieve();
    }
  }
  ...
  public System.Threading.Tasks.Task<csp.systems.POIResult> CreatePOIAsync(string title,string description,string name,csp.common.StringArray? tags,csp.systems.EPointOfInterestType type,string owner,csp.systems.GeoLocation location,csp.systems.AssetCollection assetCollection, System.Action<float>? progressCallback = null)
  {
    ...
    System.Action<csp.systems.POIResult>? handler = null;
    handler = new ((csp.systems.POIResult result) =>
    {
        try
        {
            ...
            * Sometime's it's just a space entity, or a bool, or something else. */
            ...
            if((object)result is csp.systems.ResultBase _result)
            {
                ...
                _result.ThrowOnFailure(nameof(CreatePOIAsync));
...
/*@SWIG@*/;
    ...
    CreatePOI(title,description,name,tags,type,owner,location,assetCollection, callback);
        ...
        try
        {
            ...
            * Sometime's it's just a space entity, or a bool, or something else. */
            ...
            if((object)result is csp.systems.ResultBase _result)
            {
                ...
                // Convert the failing result to a throw if we have that option enabled
                _result.ThrowOnFailure(nameof(DeletePOIAsync));
...
/*@SWIG@*/;
  ...
  public System.Threading.Tasks.Task<csp.systems.POICollectionResult> GetPOIsInAreaAsync(csp.systems.GeoLocation originLocation,double areaRadius,csp.systems.EPointOfInterestType? type, System.Action<float>? progressCallback = null)
  {
    ...
    // Define the callback that will be called by the C++ code
    System.Action<csp.systems.POICollectionResult>? handler = null;
    handler = new ((csp.systems.POICollectionResult result) =>
    {
        try
        {
           /* This is a bit jank. Due to the desire to use passthrough macros between async
            ...
            * Sometime's it's just a space entity, or a bool, or something else. */
            ...
            if((object)result is csp.systems.ResultBase _result)
            {
                ...
                // Convert the failing result to a throw if we have that option enabled
                _result.ThrowOnFailure(nameof(GetPOIsInAreaAsync));
...
/*@SWIG@*/;
    ...
    // Run the method with the provided arguments and the callback
    // callback is defined in MAKE_AWAITABLE_CALLBACK_BODY
    GetPOIsInArea(originLocation,areaRadius,type, callback);
