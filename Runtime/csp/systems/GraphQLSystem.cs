...
public class GraphQLSystem : csp.systems.SystemBase {
  ...
  internal GraphQLSystem(global::System.IntPtr cPtr, bool cMemoryOwn) : base(ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_GraphQLSystem_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
  }

  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(GraphQLSystem obj) {
    return (obj == null) ? new global::System.Runtime.InteropServices.HandleRef(null, global::System.IntPtr.Zero) : obj.swigCPtr;
  }

  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(GraphQLSystem obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void RunRequest(string RequestBody, GraphQLReceivedCallbackAdapter ApiResponse) {
    ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_GraphQLSystem_RunRequest(swigCPtr, RequestBody, GraphQLReceivedCallbackAdapter.getCPtr(ApiResponse));
  ...
  public void RunQuery(string QueryText, GraphQLReceivedCallbackAdapter ApiResponse) {
    ConnectedSpacesPlatformDotNetPINVOKE.csp_systems_GraphQLSystem_RunQuery(swigCPtr, QueryText, GraphQLReceivedCallbackAdapter.getCPtr(ApiResponse));
    if (ConnectedSpacesPlatformDotNetPINVOKE.SWIGPendingException.Pending) throw ConnectedSpacesPlatformDotNetPINVOKE.SWIGPendingException.Retrieve();
  }


  public System.Threading.Tasks.Task<csp.systems.GraphQLResult> RunRequestAsync(string requestBody, System.Action<float>? progressCallback = null)
  {
    ...
    System.Action<csp.systems.GraphQLResult>? handler = null;
    handler = new ((csp.systems.GraphQLResult result) =>
    {
        try
        {
            ...
            * Sometime's it's just a space entity, or a bool, or something else. */
            ...
            if((object)result is csp.systems.ResultBase _result)
            {
                ...
                _result.ThrowOnFailure(nameof(RunRequestAsync));
...
/*@SWIG@*/;
    ...
    RunRequest(requestBody, callback);

    return tcs.Task;
  }


  public System.Threading.Tasks.Task<csp.systems.GraphQLResult> RunQueryAsync(string queryText, System.Action<float>? progressCallback = null)
  {
    // Create a TaskCompletionSource to represent the async operation.
    System.Threading.Tasks.TaskCompletionSource<csp.systems.GraphQLResult> tcs = 
        new System.Threading.Tasks.TaskCompletionSource<csp.systems.GraphQLResult>(System.Threading.Tasks.TaskCreationOptions.RunContinuationsAsynchronously);
        ...
        try
        {
            ...
            * Sometime's it's just a space entity, or a bool, or something else. */
            ...
            if((object)result is csp.systems.ResultBase _result)
            {
                ...
                // Convert the failing result to a throw if we have that option enabled
                _result.ThrowOnFailure(nameof(RunQueryAsync));
