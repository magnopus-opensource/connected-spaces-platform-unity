...
mkdir -p DotNet/libs/visionOS/Device
mkdir -p DotNet/libs/visionOS/Simulator
...
find artifacts/visionOS-xros-* -name "*.a" -exec cp {} DotNet/libs/visionOS/Device/ \; || true
find artifacts/visionOS-xrsimulator-* -name "*.a" -exec cp {} DotNet/libs/visionOS/Simulator/ \; || true
