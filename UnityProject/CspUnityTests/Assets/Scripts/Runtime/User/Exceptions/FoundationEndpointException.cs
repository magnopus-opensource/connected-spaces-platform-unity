...
namespace Magnopus.Foundation.Unity.Runtime.User.Exceptions
{
    /// <summary>
    ...
    public class FoundationEndpointException : FoundationException
    {
        ...
        public ERequestFailureReason FailureReason { get; private set; }

        public FoundationEndpointException(string message, ushort statusCode, string responseBody = null, ERequestFailureReason failureReason = 0)
            : base(message)
        {
        ...
        public FoundationEndpointException(string message, ushort statusCode, Exception innerException, string responseBody = null, ERequestFailureReason failureReason = 0)
        ...
        public FoundationEndpointException(string message, HttpStatusCode statusCode, string responseBody = null, ERequestFailureReason failureReason = 0)
            : base(message)
        {
        ...
        public FoundationEndpointException(string message, HttpStatusCode statusCode, Exception innerException, string responseBody = null, ERequestFailureReason failureReason = 0)
            : base(message, innerException)
        {
            StatusCode = (ushort)statusCode;
            ResponseBody = responseBody;
